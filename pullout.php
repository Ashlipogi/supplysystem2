...
// Fetch pulled-out data from the database
$sql = "SELECT * FROM supply WHERE status = 'pulled out'"; // Fetch records marked as pulled out
        ...
        <a class="navbar-brand d-flex align-items-center" href="admin.php">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ms-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="pullout.php">
